...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a MERN application",
    description: "The Natours App",
...
export const projects = [
  {
    ...
    img: "/lb.png",
    iconLists: ["java.svg", "mysql.svg", "/tail.svg", "/ts.svg", "/fm.svg"],
  ...
  },
  {
    ...
    img: "/camping.png",
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/three.svg", "/mongodb.svg"],
...
export const workExperience = [
  {
    id: 1,
    title: "Technical Lead @JLUG",
    desc: "Worked 3 years int the technical of JLUG and assisted in the  development of a web-based platform using React.js, enhancing interactivity.",
  ...
  // },
  {
    ...
    desc: "Served as the member of Association and Computing Machinery in the graphics and technical domain.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
